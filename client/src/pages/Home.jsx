    ...
    <>
      <MainLayout  >
        {!isLoggedIn ? (
          ...
          <div className='bg--100 text-dark h-[50vh] py-20 text-center flex flex-col justify-center items-center '>
             <img className="m-10  w-16 md:w-32 lg:w-48" style={{borderRadius:"200rem",width:"8rem",margin:"2rem"}} src="images/tick.jpg"></img>
           
            <h1 className="mb-5 text-center sm:text-left" style={{fontFamily:"roboto",fontSize:"3rem"}}><b>Organize Your work, finally!</b></h1>
